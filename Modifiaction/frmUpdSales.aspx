<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmUpdSales.aspx.cs" Inherits="Modifiaction_frmUpdSales" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                ...
                <h3 class="text-center head">
                    <asp:Label ID="lblHeading" Text="UPDATE SALES VOUCHER" runat="server"></asp:Label>
                ...
                <div class="container_fluid">
                    <div class="row">
                        ...
                        <div class="panel panel-default pmb0">
                            <div id="divSearch" runat="server" class="panel-heading pb0">
                                <div class="col-md-12">
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <tr id="collapse_me_tr">
                                                            ...
                                                            <td class="c btct">
                                                                <asp:LinkButton ID="btnSave" Text="Save" CommandName="RowUpdate" CommandArgument='<%#Container.DataItemIndex %>' CssClass="btn btn-sxs btn-primary add_btn sbtn-26" runat="server"></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        ...
                                                        <td class="c">
                                                            <asp:Label ID="ddlPA" Text='<%#Eval("PADesc") %>' runat="server"></asp:Label></td>
                                                        <td class="r">
                                                        ...
                                                        <td class="c">
                                                            <asp:Label ID="ddlIsd" Text='<%#Eval("ISDDesc") %>' runat="server"></asp:Label></td>
                                                        <td class="c">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="pull-left">
                                                ...
                                                <asp:Button ID="btnCancel" Text="Cancel" runat="server" OnClick="btnCancel_Click" Style="display: block" CssClass="btn btn-warning" />
                                            </div>
                                            <div class="pull-right">
                                                ...
                                                <asp:Button ID="btnSave" OnClick="btnSave_Click" ValidationGroup="a" runat="server" Text="Update" CssClass="btn btn-primary btn-space-right" />
                                                <asp:Button ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear" CssClass="btn btn-danger btn-space-right" />
                                                <asp:Button ID="btnBack" OnClick="btnBack_Click" runat="server" Text="Back" Visible="false" CssClass="btn btn-warning btn-space-right" />
                                            </div>
