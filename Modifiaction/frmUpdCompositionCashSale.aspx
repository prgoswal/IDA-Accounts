<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmUpdCompositionCashSale.aspx.cs" Inherits="Modifiaction_frmUpdCashSale" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">UPDATE BILL OF SUPPLY CASH SALES
                            ...
                            <asp:Panel ID="pnlBodyContent" runat="server" Enabled="false">
                                <div class="panel-body">
                                    <div style="padding-left: 15px">
                                        ...
                                        <table class="table table-voucher sales2_invoice table-bordered gstr_sales_invoice tdb0" style="width: 440px; float: left">
                                            <tbody>
                                                <tr>
                                                    <td class="w25 hidden">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <asp:GridView ID="gvItemDetail" CssClass="gstr-table hid table-bordered supd_table mb10" AutoGenerateColumns="false" OnRowCommand="gvItemDetail_RowCommand" OnRowDataBound="gvItemDetail_RowDataBound" runat="server">
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <td class="c">
                                                            <asp:LinkButton ID="btnEdit" Text="Edit" CommandName="RowEdit" CommandArgument='<%#Container.DataItemIndex %>' CssClass="btn btn-sxs btn-info add_btn" runat="server"></asp:LinkButton>
