...
public partial class Modifiaction_frmUpdSales : System.Web.UI.Page
{
    ...
    DataTable dtgrdview;
    UpdateCompositionSalesModel ObjSaleModel;
    ...
    private void BindCancelReason()
    {
        try
        {
            ...
            ObjSaleModel = new UpdateCompositionSalesModel();
    ...
    void BindAll()
    {
        ...
        string uri = string.Format("UpdateCompositionSalesVoucher/BindAll");
    ...
    void FillOnIncomeHead()
    {
        if (ddlIncomeHead.SelectedValue == CashSalesAcc)
        {
            ...
            ddlSalesto.Visible = ddlShippingAdd.Visible = false;//= ddlGstinNo.Visible
            txtorderNo.Enabled = txtOrderDate.Enabled = false;// ddlTds.Enabled = ddlTCS.Enabled = false;
            tblShippingDetail.Visible = true;
        }
        else
        {
            txtorderNo.Enabled = txtOrderDate.Enabled = true;// ddlTds.Enabled = ddlTCS.Enabled = true;
    ...
    void FillGSTIN()
    {
        ...
        string uri = string.Format("UpdateCompositionSalesVoucher/FillGistnNo");
    ...
    void FillShippingAddress()
    {
        ...
        string uri = string.Format("UpdateCompositionSalesVoucher/FillShippingAddress");
    ...
    void Filllocation()
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionSalesVoucher/Filllocation");
    ...
    protected void btnSearchInvoice_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionSalesVoucher/SearchSaleInvoice");
    ...
    void FillInvoiceDetail(DataRow drInInfo)
    {
        ...
        txtPartyBank.Text = drInInfo["PartyBank"].ToString();
        txtPartyIFSC.Text = drInInfo["PartyIFSC"].ToString();
    ...
    void GetRowData()
    {
        ...
        //GvRow.txtTax.Text = editedRow["TaxRate"].ToString();s
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionSalesVoucher/FillItemSellRate");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjSaleModel.PartyBank = txtPartyBank.Text;
            ObjSaleModel.PartyIFSC = txtPartyIFSC.Text;
            ...
            string uri = string.Format("UpdateCompositionSalesVoucher/UpdateSaleVoucher");
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionSalesVoucher/CancelVoucher");
