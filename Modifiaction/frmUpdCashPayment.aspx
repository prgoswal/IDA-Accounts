<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmUpdCashPayment.aspx.cs" Inherits="Modifiaction_frmUpdCashPayment" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">CASH PAYMENT UPDATION
                            ...
                            <div class="panel-body">
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        <table class="cashpayment_table1 table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 17%" class="hidden">
                                                    <label>Last Transaction No.</label></th>
                                                <th style="width: 17%">
                                        ...
                                        <table id="tbl_id" class="cashpayment_table2 table-bordered">
                                            <thead>
                                                <tr class="inf_head">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <%--<cc1:ComboBox ID="txtAccountHead" CssClass="inpt autoCopleteBox relative_gt" runat="server" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="txtAccountHead_SelectedIndexChanged" placeholder="p" AutoCompleteMode="SuggestAppend" CaseSensitive="False" Style="text-transform: uppercase"></cc1:ComboBox>--%>
                                                    ...
                                                    <td class="col6">
                                                        ...
                                                        <asp:RegularExpressionValidator ControlToValidate="txtAmount" ID="regExVal" runat="server" ErrorMessage="Please Enter Amount." Display="Dynamic" ValidationGroup="btnAdd" CssClass="gst-ac-error" ValidationExpression="^[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$" />                                                    </td>
                                                    <td class="col7">
                                        ...
                                        <asp:GridView ID="gvCashPayment" CssClass="cashpayment_table2_grid table-bordered" OnRowCommand="gvCashPayment_RowCommand" AutoGenerateColumns="false" runat="server" ShowHeader="false">
                                            <Columns>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <asp:TextBox ID="txtInvoiceTotalAmount" Width="120px" Enabled="false" Text="0" CssClass="inpt Invoice_date" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="11">
