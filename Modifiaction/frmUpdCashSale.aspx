<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmUpdCashSale.aspx.cs" Inherits="Modifiaction_frmUpdCashSale" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">UPDATE CASH SALES VOUCHER 
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <asp:Button ID="btnSave" Text="Update" class="btn btn-primary btn-space-right" runat="server" OnClick="btnSave_Click" OnClientClick="return Validation();" />
