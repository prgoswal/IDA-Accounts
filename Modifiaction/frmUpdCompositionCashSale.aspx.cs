...
{
    UpdateCompositionCashSaleModel objCompositionCashSalesModel = new UpdateCompositionCashSaleModel();
    ...
    private void BindCancelReason()
    {
        try
        {
            ...
            objCompositionCashSalesModel = new UpdateCompositionCashSaleModel();
    ...
    void BindAll()
    {
        ...
        objCompositionCashSalesModel.ByCashSale = 1;
    ...
    void FillGSTIN()
    {
        ...
        objCompositionCashSalesModel.YrCD = GlobalSession.YrCD;
        objCompositionCashSalesModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        objCompositionCashSalesModel.AccCode = CommonCls.ConvertIntZero(0);

        string uri = string.Format("UpdateCompositionCashSales/FillGistnNo");
        DataTable dtGSTIN = CommonCls.ApiPostDataTable(uri, objCompositionCashSalesModel);
    ...
    {
        objCompositionCashSalesModel = new UpdateCompositionCashSaleModel();
        objCompositionCashSalesModel.Ind = 4;
        objCompositionCashSalesModel.OrgID = GlobalSession.OrgID;
        objCompositionCashSalesModel.BrID = GlobalSession.BrID;
        objCompositionCashSalesModel.YrCD = GlobalSession.YrCD;
        objCompositionCashSalesModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        objCompositionCashSalesModel.AccCode = CommonCls.ConvertIntZero(0);
        objCompositionCashSalesModel.GSTIN = "";

        string uri = string.Format("UpdateCompositionCashSales/FillShippingAddress");
        DataTable dtShipping = CommonCls.ApiPostDataTable(uri, objCompositionCashSalesModel);
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            //    if (!string.IsNullOrEmpty(ddlGstinNo.SelectedValue))
            //    {
            //        objCompositionCashSalesModel = new UpdateCashSaleModel();
            //        objCompositionCashSalesModel.Ind = 15;
            //        string uriGSTIn = string.Format("Master/Master");
            //        DataTable dtState = CommonCls.ApiPostDataTable(uriGSTIn, objCompositionCashSalesModel);
            ...
            objCompositionCashSalesModel.BrID = GlobalSession.BrID;
            objCompositionCashSalesModel.VchType = Convert.ToInt32(ViewState["VchType"]);
            objCompositionCashSalesModel.ItemID = CommonCls.ConvertIntZero(GvRow.ddlItemName.SelectedValue);
            objCompositionCashSalesModel.ByCashSale = 1;

            string uri = string.Format("UpdateCompositionCashSales/FillItemSellRate");
    ...
    protected void btnAddOtherCharges_Click(object sender, EventArgs e)
    {
        ...
        tblTransportDetail.Visible = false;//  tblGSTINInvoice.Visible = false;
    ...
    protected void btnSearchInvoice_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCompositionCashSalesModel.YrCD = GlobalSession.YrCD;
            objCompositionCashSalesModel.VchType = Convert.ToInt32(ViewState["VchType"]);
            objCompositionCashSalesModel.InvoiceNo = CommonCls.ConvertIntZero(txtSearchInvoice.Text);

            switch (CommonCls.ConvertIntZero(VsdtSeries.Rows[0]["SeriesType"]))
            {
                case 1: /// Manual Series
                    objCompositionCashSalesModel.InvoiceSeries = "";//txtInvoiceSeriesFind.Text;
                    break;

                case 2: /// Available Series
                    if (ddlInvoiceSeriesFind == null || string.IsNullOrEmpty(ddlInvoiceSeriesFind.SelectedValue))
                    {
                        ddlInvoiceSeriesFind.Focus();
                        ShowMessage("Select Invoice Series.", false);
                        return;
                    }
                    objCompositionCashSalesModel.InvoiceSeries = ddlInvoiceSeriesFind.SelectedItem.Text;
                    break;
            ...
            string uri = string.Format("UpdateCompositionCashSales/SearchSaleInvoice");
            DataSet dsSearchInvoice = CommonCls.ApiPostDataSet(uri, objCompositionCashSalesModel);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //objCompositionCashSalesModel.InvoiceSeries = "CASH";
            objCompositionCashSalesModel.PartyName = "";//ddlPartyName.SelectedItem == null ? "" : ddlPartyName.SelectedItem.Text; //txtPartyDetailPartyName.Text;
            objCompositionCashSalesModel.PartyMobileNo = CommonCls.ConvertLongZero(0); //CommonCls.ConvertLongZero(txtPartyDetailMobileNo.Text);
            objCompositionCashSalesModel.PartyGSTIN = "";//ddlGstinNo.Text.ToUpper();
            ...
            objCompositionCashSalesModel.PartyAddress = "";//ddlShippingAdd.SelectedItem == null ? "" : ddlShippingAdd.SelectedItem.Text; //ddlIncomeHead.SelectedValue == CashSalesAcc ? txtShippingAdd.Text.ToUpper() :
            //ddlShippingAdd.SelectedItem != null ? ddlShippingAdd.SelectedItem.Text.ToUpper() : "";

            objCompositionCashSalesModel.WareHouseID = CommonCls.ConvertIntZero(ddlLocation.SelectedValue);
            objCompositionCashSalesModel.PONo = "";
            objCompositionCashSalesModel.DocNo = VoucharNo;
            ...
            string uri = string.Format("UpdateCompositionCashSales/UpdateSaleVoucher");
    ...
    DataTable CreateCashSalesData()
    {
        ...
        //{
        drCashSales["AccPOSID"] = Convert.ToInt32(0);
        //}
    ...
    void ClearAll()
    {
        ...
        txtPMRemark.Text = "";
        txtGross.Text = txtTax.Text = txtAddLess.Text = txtNetAmount.Text = txtItemAmount.Text = txtDiscountAmount.Text = "";
        ddlNarration.ClearSelection();

        tblOtherCharge.Visible = tblTransportDetail.Visible = divFree.Visible =
             grdOtherCharge.Visible = false;// tblGSTINInvoice.Visible = 
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCompositionCashSalesModel = new UpdateCompositionCashSaleModel();
            objCompositionCashSalesModel.Ind = 12;
            objCompositionCashSalesModel.OrgID = GlobalSession.OrgID;
            objCompositionCashSalesModel.BrID = GlobalSession.BrID;
            objCompositionCashSalesModel.DocNo = 6;
            objCompositionCashSalesModel.InvoiceSeries = ddlInvoiceSeriesFind.SelectedItem.Text;
            objCompositionCashSalesModel.InvoiceNo = Convert.ToInt32(txtinvoiceNo.Text);
            objCompositionCashSalesModel.CancelReason = ddlCancelReason.SelectedItem.Text;
            string uri = string.Format("UpdateCompositionCashSales/CancelVoucher");
            DataTable dtSave = CommonCls.ApiPostDataTable(uri, objCompositionCashSalesModel);
            if (dtSave.Rows.Count > 0)
            {
                if (dtSave.Rows[0]["ReturnInd"].ToString() == "1")
                {
                    ClearAll();
                    pnlConfirmInvoice.Visible = false;
                    ShowMessage("Invoice No. - " + txtSearchInvoice.Text + " is Cancel successfully ", true);
                }
                else if (dtSave.Rows[0]["ReturnInd"].ToString() == "0")
                {
                    pnlConfirmInvoice.Visible = false;
                    ShowMessage("Vouchar is not Cancel for Invoice No. " + objCompositionCashSalesModel.InvoiceNo, true);
                    //ClearAll();
                }
            }
            else
