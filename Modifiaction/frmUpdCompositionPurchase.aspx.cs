...
public partial class Modifiaction_UpdPurchase : System.Web.UI.Page
{
    ...
    UpdateCompositionPurchaseVoucherModel objUpdPurchaseModel;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlPurchaseFrom.Enabled = txtPurchaseFrom.Enabled = ddlShippingAdd.Enabled =//ddlGstinNo.Enabled = txtGstinNo.Enabled = 
                txtShippingAdd.Enabled = ddlLocation.Enabled = ddlPayMode.Enabled = false;
    ...
    void BindAll()
    {
        objUpdPurchaseModel = new UpdateCompositionPurchaseVoucherModel();
        ...
        string uri = string.Format("UpdateCompositionPurchaseVoucher/BindAll");
    ...
    protected void btnSearchVoucher_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionPurchaseVoucher/LoadPurchaseVoucherDetails");
            ...
            if (dsPVBasicDetails.Tables.Count > 0)
            {
                ...
                if (dtBasicDetails.Rows.Count > 0)
                {
                    ...
                    if (Convert.ToDateTime(dtBasicDetails.Rows[0]["VoucharDate"]).ToString("dd/MM/yyyy") == "01/01/1900")
                        ...
                        txtVoucherDate.Text = Convert.ToDateTime(dtBasicDetails.Rows[0]["VoucharDate"]).ToString("dd/MM/yyyy");
                    ...
                    if (byCashSales == 0)
                    {
                        ...
                        txtPurchaseFrom.Visible = txtShippingAdd.Visible = false; //txtGstinNo.Visible =
                    ...
                    else
                    {
                        ...
                        txtPurchaseFrom.Visible = txtShippingAdd.Visible = true;//txtGstinNo.Visible =
                    ...
                    txtBillDate.Text = Convert.ToDateTime(dtBasicDetails.Rows[0]["PurchaseBillDate"]).ToString("dd/MM/yyyy");
                ...
                if (dtItemDetails.Rows.Count > 0)
                {
                    ...
                    //dtItemDetails.Columns.Add("ItemInd", typeof(int));
    ...
    void Filllocation()
    {
        ...
        string uri = string.Format("UpdateCompositionPurchaseVoucher/Filllocation");
    ...
    void FillShippingAddress()
    {
        ...
        string uri = string.Format("UpdateCompositionPurchaseVoucher/FillShippingAddress");
    ...
    protected void ddlPurchaseFrom_SelectedIndexChanged(object sender, EventArgs e)    //ddlSales To Selected Index Chanage Gstin Number 
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionPurchaseVoucher/FillGistnNo");
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            //}
            objUpdPurchaseModel.GSTIN = "";
            string uri = string.Format("UpdateCompositionPurchaseVoucher/FillItemPurchaseRate");
        ...
        try
        {
            ...
            if (e.CommandName == "EditRow")
            {
                ...
                if (drEditItemsDetails["ItemInd"].ToString() == "0")
                {
                    ...
                    txtItemTaxableAmt.Enabled = false;// txtTaxRate.Enabled = txtCGSTAmt.Enabled = txtSGSTAmt.Enabled = txtIGSTAmt.Enabled = txtCESSAmt.Enabled = false;
                }
                else
                {
                    //ddlEdit.SelectedValue = "1";
                    txtItemTaxableAmt.Enabled = true;// txtTaxRate.Enabled = txtCGSTAmt.Enabled = txtSGSTAmt.Enabled = txtIGSTAmt.Enabled = txtCESSAmt.Enabled = true;
                }
    ...
    void SelectioPA()
    {
        // txtCGSTAmt.Enabled = txtSGSTAmt.Enabled = txtIGSTAmt.Enabled = txtCESSAmt.Enabled = txtItemTaxableAmt.Enabled =
        txtItemAmt.Enabled = false;
        txtDiscount.Focus();
    ...
    void BindGvItemDetail()
    {
        ...
        if (VsdtItems != null)
        {
            ...
            DrGvItemDetail["ITCApplicable"] = Convert.ToInt16(0);
            DrGvItemDetail["ITCIGSTAmt"] = Convert.ToInt16(0) == 1 ? IgstAmt : 0;
            DrGvItemDetail["ITCSGSTAmt"] = Convert.ToInt16(0) == 1 ? SgstAmt : 0;
            DrGvItemDetail["ITCCGSTAmt"] = Convert.ToInt16(0) == 1 ? CgstAmt : 0;
            DrGvItemDetail["ITCCESSAmt"] = Convert.ToInt16(0) == 1 ? CessAmt : 0;
    ...
    void ClearItemDetailTable()
    {
        ...
        txtDiscount.Text = txtItemTaxableAmt.Text =

        txtItemRemark.Text = txtMinorUnitQty.Text = "";
        //        txtCGSTAmt.Text = txtSGSTAmt.Text = txtIGSTAmt.Text = txtCESSAmt.Text = txtTaxRate.Text =
    ...
    protected void btnUpdate_Click(object sender, EventArgs e) // Update Purchase Voucher
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionPurchaseVoucher/UpdatePV");
    ...
    void ClearAll()
    {
        ...
        txtItemTaxableAmt.Text = "";//txtTaxRate.Text = txtCGSTAmt.Text = txtSGSTAmt.Text = txtIGSTAmt.Text = txtCESSAmt.Text = "";
        txtItemRemark.Text = "";
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string uri = string.Format("UpdateCompositionPurchaseVoucher/CancelVoucher");
            ...
            if (dtSave.Rows.Count > 0)
            {
                if (dtSave.Rows[0]["CancelInd"].ToString() == "1")
                {
                    ...
                    ClearAll();
                    ShowMessage("Vouchar No. - " + objUpdPurchaseModel.VoucherNo + " is Cancel successfully ", true);

                }
                else if (dtSave.Rows[0]["CancelInd"].ToString() == "0")
                {
                    pnlConfirmInvoice.Visible = false;
                    ShowMessage("Vouchar is not Cancel Please Try Again. ", false);
                    //ClearAll();
                }
            }
            else
