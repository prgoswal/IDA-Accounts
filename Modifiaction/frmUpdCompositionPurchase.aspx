<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MainMaster.master" CodeFile="frmUpdCompositionPurchase.aspx.cs" Inherits="Modifiaction_UpdPurchase" %>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <table class="table table-voucher table-bordered table-form gstr_sales_item" id="addtothis" style="margin-bottom: 80px;">
                                        <thead>
                                            ...
                                            <tr>
                                                <th rowspan="2" style="width: 25%">Expense Head</th>
                                                <th rowspan="2" style="width: 25%">Item Name</th>
                                                <th colspan="2">Primary</th>
                                                <th colspan="2">Secondary</th>
                                                <th rowspan="2" style="width: 4%">Free</th>
                                                <th rowspan="2" style="width: 6%">Rate</th>
                                                <th rowspan="2" style="width: 6%">Item Amount</th>
                                                <th rowspan="2" style="width: 5%">Discount<br />
                                                    <span style="font-size: 11px">% / Amt.</span></th>
                                                <%--<th rowspan="2" style="wi   dth: 3%">Edit</th>--%>
                                                <th rowspan="2" style="width: 5%">Amount</th>
                                                <th rowspan="2" style="width: 3%" runat="server" visible="false">ITC</th>
                                        ...
                                        <tbody>
                                            <tr class="form-tr">
                                                <td>
                                                    <cc1:ComboBox ID="ddlExpenseHead" AutoPostBack="true" OnSelectedIndexChanged="ddlExpenseHead_SelectedIndexChanged" runat="server" Width="250px" placeholder="p" CssClass="relative_gt" AutoCompleteMode="SuggestAppend" CaseSensitive="False" Style="text-transform: uppercase" />
                                                </td>
                                                <td>
                                                    <cc1:ComboBox ID="ddlItemName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlItemName_SelectedIndexChanged" Width="20px" placeholder="p" CssClass="relative_gt" AutoCompleteMode="SuggestAppend" CaseSensitive="False" Style="text-transform: uppercase" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtRate" MaxLength="9" runat="server" Text="0" CssClass="Money" OnTextChanged="txtRate_TextChanged" AutoPostBack="true"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txtItemAmt" MaxLength="9" Enabled="false" runat="server" Text="0" CssClass="Money"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txtDiscount" MaxLength="9" runat="server" CssClass="Money" Text="0" OnTextChanged="txtDiscount_TextChanged" AutoPostBack="true"></asp:TextBox></td>
                                                <td>
                                        ...
                                        <asp:GridView ID="grdItemDetails" HeaderStyle-CssClass="hidden" CssClass="table table-voucher table-bordered table-form gstr_sales_item first_tr_hide" OnRowCommand="grdItemDetails_RowCommand" OnRowDataBound="grdItemDetails_RowDataBound" AutoGenerateColumns="false" runat="server" ShowHeader="True">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <tr>
                                                            <th rowspan="2" class="inf_head" style="width: 16%;">Expense Head</th>
                                                            <th rowspan="2" class="inf_head" style="width: 15%;">Item Name</th>
                                                            ...
                                                            <th rowspan="2" class="inf_head" style="width: 2%;" runat="server" visible="false">ITC</th>
                                                            ...
                                                            <th rowspan="2" class="inf_head" style="width: 5%;">&nbsp;</th>
                                                        </tr>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="pull-left">
                                            ...
                                            <asp:Button ID="btnCancel" Text="Cancel" runat="server" OnClick="btnCancel_Click" CssClass="btn btn-warning" Enabled="false"  Visible="false"/>
                                        </div>
