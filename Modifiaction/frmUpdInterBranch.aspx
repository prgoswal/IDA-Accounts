<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmUpdInterBranch.aspx.cs" Inherits="Modifiaction_frmUpdInterBranch" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                                ...
                                <div class="col-sm-12">
                                    <table class="search_updCash_table table-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnSearch" CssClass="btn btn-primary btn-sxs" runat="server" OnClick="btnSearch_Click" Text="Search"  />
                                            </td>
                                        </tr>
                                        <tr>
                                        </tr>
                                    ...
                                    <asp:GridView ID="gvInterBranch" CssClass="bankreceipt_table2_grid table-bordered" AutoGenerateColumns="false" runat="server" ShowHeader="false" OnRowCommand="gvInterBranch_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="col7">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDRCR" Text='<%#Eval("AmountType") %>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="pull-left">
                                            ...
                                            <asp:Button ID="btnCancel" Text="Cancel" runat="server" OnClick="btnCancel_Click" Style="display: block" CssClass="btn btn-warning" Visible="true" Enabled="false" />
                                        </div>
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <asp:Button ID="btnSave" OnClick="btnSave_Click" runat="server" Text="Update" class="btn btn-primary btn-space-right"  />
            ...
            <asp:Panel runat="server" ID="pnlConfirmInvoice" CssClass="modalPop" Visible="false" Style="position: absolute; left: 0; right: 0">
                <div class="panel panel-primary bodyContent" style="width: 30%; padding: 0;max-height:initial;overflow:initial">
