...
public partial class Modifiaction_frmUpdPurchaseReturn : System.Web.UI.Page
{
    #region Declarations

    UpdatePurchaseReturnVoucherModel objUpdPurchaseReturnModel;
    ...
    private void BindCancelReason()
    {
        try
        {
            objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
            objUpdPurchaseReturnModel.Ind = 100;
            string uri = string.Format("Master/Master");
            DataTable dtCancelReason = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
    ...
    {
        objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
        objUpdPurchaseReturnModel.Ind = 11;
        objUpdPurchaseReturnModel.OrgID = GlobalSession.OrgID;
        objUpdPurchaseReturnModel.BrID = GlobalSession.BrID;
        objUpdPurchaseReturnModel.YrCD = GlobalSession.YrCD;
        objUpdPurchaseReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        string uri = string.Format("UpdatePurchaseReturnVoucher/BindAll");
        DataSet dsBindAll = CommonCls.ApiPostDataSet(uri, objUpdPurchaseReturnModel);
    ...
    protected void btnSearchVoucher_Click(object sender, EventArgs e)
    {
        ...
        {
            objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
            objUpdPurchaseReturnModel.Ind = 1;
            objUpdPurchaseReturnModel.OrgID = GlobalSession.OrgID;
            objUpdPurchaseReturnModel.BrID = GlobalSession.BrID;
            objUpdPurchaseReturnModel.YrCD = GlobalSession.YrCD;
            objUpdPurchaseReturnModel.VchType = CommonCls.ConvertIntZero(ViewState["VchType"]);
            objUpdPurchaseReturnModel.DocNo = CommonCls.ConvertIntZero(txtSearchVoucher.Text);
            string uri = string.Format("UpdatePurchaseReturnVoucher/LoadPurchaseVoucherDetails");
            DataSet dsPVBasicDetails = CommonCls.ApiPostDataSet(uri, objUpdPurchaseReturnModel);
            if (dsPVBasicDetails.Tables.Count > 0)
            {
                ...
                VsDtOrgInvoicNoAndDate = dsPVBasicDetails.Tables["OrgInoiceNoAndDate"];
                ...
                if (dtBasicDetails.Rows.Count > 0 && dtItemDetails.Rows.Count > 0)
                {
                    ...
                    btnAdd.Enabled = btnUpdate.Enabled = btnCancel.Enabled = true;
                }
                else
                {
    ...
    void Filllocation()
    {
        ...
        string uri = string.Format("UpdatePurchaseReturnVoucher/Filllocation");
        DataTable dtLocation = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
    ...
    void FillShippingAddress()
    {
        ...
        string uri = string.Format("UpdatePurchaseReturnVoucher/FillShippingAddress");
        DataTable dtShipping = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
    ...
    protected void txtGstinNo_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
                objUpdPurchaseReturnModel.Ind = 15;
                string uri = string.Format("Master/Master");
                DataTable dtState = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
    ...
    protected void ddlPurchaseFrom_SelectedIndexChanged(object sender, EventArgs e)    //ddlSales To Selected Index Chanage Gstin Number 
    {
        try
        {
            ...
            string uri = string.Format("UpdatePurchaseReturnVoucher/FillGistnNo");
            DataTable dtGSTIN = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
            objUpdPurchaseReturnModel.Ind = 11;//1;
            objUpdPurchaseReturnModel.OrgID = GlobalSession.OrgID;
            objUpdPurchaseReturnModel.BrID = GlobalSession.BrID;
            objUpdPurchaseReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
            objUpdPurchaseReturnModel.PartyCode = CommonCls.ConvertIntZero(ddlPurchaseFrom.SelectedValue);
            objUpdPurchaseReturnModel.ByCashSale = PayModeIsCredit ? 0 : 1;
            objUpdPurchaseReturnModel.ItemID = CommonCls.ConvertIntZero(ddlItemName.SelectedValue);

            if (ddlGstinNo.SelectedItem != null)
            {
                if (!string.IsNullOrEmpty(ddlGstinNo.SelectedValue))
                {
                    objUpdPurchaseReturnModel.GSTIN = ddlGstinNo.SelectedValue;
                }
            }

            if (PayModeIsCredit)
            {
                objUpdPurchaseReturnModel.GSTIN = txtGstinNo.Text.ToUpper().ToString();
            }

            string uri = string.Format("UpdatePurchaseReturnVoucher/FillItemPurchaseRate");
            DataSet dsItems = CommonCls.ApiPostDataSet(uri, objUpdPurchaseReturnModel);
    ...
    protected void txtQty_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                txtQty.Focus();
                ShowMessage("Item Quantity Cannot be greater than Original Item Quantity = " + hfOrgQty.Value, false);
                return;
            }
    ...
    protected void grdItemDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "EditRow")
            {
                ...
                hfOrgQty.Value = drEditItemsDetails["OrgQty"].ToString();
                hfOrgRate.Value = drEditItemsDetails["OrgRate"].ToString();
    ...
    void BindGvItemDetail()
    {
        ...
        if (VsdtItems != null)
        {
            ...
            DrGvItemDetail["OrgQty"] = hfOrgQty.Value;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e) // Update Purchase Voucher
    {
        try
        {
            ...
            objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
            objUpdPurchaseReturnModel.Ind = 2;
            objUpdPurchaseReturnModel.OrgID = GlobalSession.OrgID;
            objUpdPurchaseReturnModel.BrID = GlobalSession.BrID;
            objUpdPurchaseReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);

            objUpdPurchaseReturnModel.EntryType = 2;
            objUpdPurchaseReturnModel.YrCD = GlobalSession.YrCD;
            objUpdPurchaseReturnModel.User = GlobalSession.UserID;
            objUpdPurchaseReturnModel.IP = GlobalSession.IP;

            objUpdPurchaseReturnModel.ByCashSale = PayModeIsCredit ? 0 : 1;
            objUpdPurchaseReturnModel.PartyName = PayModeIsCredit ? ddlPurchaseFrom.SelectedItem.Text.ToUpper() : txtPurchaseFrom.Text;
            objUpdPurchaseReturnModel.PartyGSTIN = PayModeIsCredit && ddlGstinNo.SelectedItem != null ? ddlGstinNo.SelectedItem.Text.ToUpper() : txtGstinNo.Text.ToUpper();
            objUpdPurchaseReturnModel.PartyAddress = PayModeIsCredit && ddlShippingAdd.SelectedItem != null ? ddlShippingAdd.SelectedItem.Text.ToUpper() : txtShippingAdd.Text.ToUpper();

            objUpdPurchaseReturnModel.WareHouseID = Convert.ToInt32(ddlLocation.SelectedValue);
            objUpdPurchaseReturnModel.PONo = txtOrderNo.Text;
            objUpdPurchaseReturnModel.PODate = CommonCls.ConvertToDate(txtOrderDate.Text);
            objUpdPurchaseReturnModel.VoucherNo = CommonCls.ConvertIntZero(txtSearchVoucher.Text);
            objUpdPurchaseReturnModel.PurchaseSaleRecordID = Convert.ToInt64(hfPurchaseSaleRecordID.Value);
            objUpdPurchaseReturnModel.AccCode = PayModeIsCredit ? CommonCls.ConvertIntZero(ddlPurchaseFrom.SelectedValue) : Convert.ToInt32(ddlPayMode.SelectedValue);
            objUpdPurchaseReturnModel.VoucherDate = CommonCls.ConvertToDate(txtVoucherDate.Text);
            objUpdPurchaseReturnModel.PurchaseBillNo = txtBillNo.Text;
            objUpdPurchaseReturnModel.PurchaseBillDate = CommonCls.ConvertToDate(txtBillDate.Text);
            objUpdPurchaseReturnModel.GRNNo = txtGRNNo.Text;
            objUpdPurchaseReturnModel.GRNDate = CommonCls.ConvertToDate(txtGRNDate.Text);
            objUpdPurchaseReturnModel.OrgVoucherNo = Convert.ToInt32(VsDtOrgInvoicNoAndDate.Rows[0]["InvoiceNo"].ToString());
            objUpdPurchaseReturnModel.OrgVoucherDate = CommonCls.ConvertToDate(CommonCls.ConvertDateDB(VsDtOrgInvoicNoAndDate.Rows[0]["InvoiceDate"].ToString()));

            objUpdPurchaseReturnModel.CCCode = CommonCls.ConvertIntZero(ddlCostCenter.SelectedValue);

            objUpdPurchaseReturnModel.DtUpdPurchase = DtPurchaseSchema();
            objUpdPurchaseReturnModel.DtUpdItems = DtItemsSchema();

            objUpdPurchaseReturnModel.DtUpdPurchase = CreatePurchaseData();
            ...
            objUpdPurchaseReturnModel.DtUpdItems = VsdtGvItemDetail;
            if (objUpdPurchaseReturnModel.DtUpdItems != null)
            {
                if (objUpdPurchaseReturnModel.DtUpdItems.Columns.Contains("ItemMinorUnitName"))
                {
                    objUpdPurchaseReturnModel.DtUpdItems.Columns.Remove("ItemMinorUnitName");
                }
                if (objUpdPurchaseReturnModel.DtUpdItems.Columns.Contains("OrgQty"))
                {
                    objUpdPurchaseReturnModel.DtUpdItems.Columns.Remove("OrgQty");
                }
                if (objUpdPurchaseReturnModel.DtUpdItems.Columns.Contains("OrgRate"))
                {
                    objUpdPurchaseReturnModel.DtUpdItems.Columns.Remove("OrgRate");
                }
            }
            objUpdPurchaseReturnModel.DtUpdSundries = VsdtSundri;
            if ((objUpdPurchaseReturnModel.DtUpdSundries == null) || (objUpdPurchaseReturnModel.DtUpdSundries.Rows.Count == 0))
            {
                objUpdPurchaseReturnModel.DtUpdSundries = DtSundriesSchema();
                DataRow drSaleSundri = objUpdPurchaseReturnModel.DtUpdSundries.NewRow();
                drSaleSundri["SundriCode"] = 0;
                drSaleSundri["SundriHead"] = "0";
                drSaleSundri["SundriInd"] = "0";
                drSaleSundri["SundriAmt"] = 0;
                objUpdPurchaseReturnModel.DtUpdSundries.Rows.Add(drSaleSundri);
            }

            string uri = string.Format("UpdatePurchaseReturnVoucher/UpdatePurchaseReturn");
            DataTable dtUpdPurchase = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
    ...
    private bool CheckGSTINNumber_Validation()
    {
        try
        {
            ...
            if (CheckGSTIN_Expression == true)
            {
                ...
                objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
                objUpdPurchaseReturnModel.Ind = 6;
                objUpdPurchaseReturnModel.OrgID = GlobalSession.OrgID;
                objUpdPurchaseReturnModel.BrID = GlobalSession.BrID;
                objUpdPurchaseReturnModel.AccCode = Convert.ToInt32(ddlPurchaseFrom.SelectedItem.Value);



                string uri = string.Format("PurchaseVoucher/CheckGSTIN_Number");

                DataSet dtStatePanNo = CommonCls.ApiPostDataSet(uri, objUpdPurchaseReturnModel);
    ...
    void ClearAll()
    {
        ...
        txtItemTaxableAmt.Text = txtFree.Text = txtQty.Text = txtRate.Text = txtItemAmt.Text = txtDiscount.Text = txtTax.Text = "";
        txtTaxRate.Text = txtCGSTAmt.Text = txtSGSTAmt.Text = txtIGSTAmt.Text = txtCESSAmt.Text = "";
        txtItemRemark.Text = "";

        VsdtGvItemDetail = VsDtOrgInvoicNoAndDate = VsdtSundri = null;
        ...
        btnAddItemDetail.Enabled = btnAdd.Enabled = btnUpdate.Enabled = false;
        btnAddItemDetail.Text = "Add";
    }
    ...
    //    objUpdPurchaseReturnModel.PartyCode = CommonCls.ConvertIntZero(ddlPurchaseFrom.SelectedValue);
    //    objUpdPurchaseReturnModel.ByCashSale = PayModeIsCredit ? 0 : 1;
    //    objUpdPurchaseReturnModel.ItemID = CommonCls.ConvertIntZero(ddlFreeItemName.SelectedValue);
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objUpdPurchaseReturnModel = new UpdatePurchaseReturnVoucherModel();
            objUpdPurchaseReturnModel.Ind = 3;
            objUpdPurchaseReturnModel.OrgID = GlobalSession.OrgID;
            objUpdPurchaseReturnModel.BrID = GlobalSession.BrID;

            objUpdPurchaseReturnModel.VchType = 7;

            objUpdPurchaseReturnModel.VoucherNo = Convert.ToInt32(txtSearchVoucher.Text);

            objUpdPurchaseReturnModel.CancelReason = ddlCancelReason.SelectedItem.Text;

            string uri = string.Format("UpdatePurchaseReturnVoucher/CancelVoucher");
            DataTable dtSave = CommonCls.ApiPostDataTable(uri, objUpdPurchaseReturnModel);
            if (dtSave.Rows.Count > 0)
            {
                if (dtSave.Rows[0]["CancelInd"].ToString() == "1")
                {
                    ClearAll();
                    pnlConfirmInvoice.Visible = false;
                    ShowMessage("Vouchar No. - " + objUpdPurchaseReturnModel.VoucherNo + " is Cancel successfully ", true);
                }
