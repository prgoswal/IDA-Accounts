<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="UpdfrmCreditNote.aspx.cs" Inherits="Modifiaction_UpdfrmCreditNote" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">CREDIT NOTE UPDATION
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <table class="credit_table table-bordered">
                                        <tr>
                                            <td colspan="5" class="text-center inf_head">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <th style="width: 10%">Voucher Date</th>
                                            <th style="width: 20%">Credit Note Against</th>
                                            <th style="width: 14%">Party Account</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <asp:DropDownList ID="ddlAgainst" runat="server" data-group="Save" OnSelectedIndexChanged="ddlAgainst_SelectedIndexChanged" AutoPostBack="true">
                                            ...
                                            <td class="">
                                                <asp:DropDownList ID="ddlPartyAccount" CssClass="chzn-search Required" data-group="Save" OnSelectedIndexChanged="ddlPartyAccount_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                                                <%--<cc1:ComboBox ID="ddlPartyAccount" 
                                                            CssClass="inpt autoCopleteBox relative_gt" 
                                                            runat="server" Width="250px"
                                                            AutoPostBack="true" placeholder="p"
                                                            DropDownStyle="Simple"
                                                            OnSelectedIndexChanged="ddlPartyAccount_SelectedIndexChanged"
                                            ...
                                            <td class="">
                                                <asp:DropDownList ID="ddlGstinNo" runat="server"></asp:DropDownList></td>
                                    ...
                                    <table class="original_invoice_table  table-bordered" style="float: left; margin-bottom: 25px">
                                        ...
                                        <tr>
                                            <td class="original_invoice_col1 c">
                                                <asp:CheckBox ID="CBGSTImapactTaken" AutoPostBack="true" runat="server" /></td>
                                    ...
                                    <table class="original_invoice_table  table-bordered" style="margin-left: 10px; float: right; margin-bottom: 25px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="ddlAccountHead" CssClass="chzn-search Required" data-group="Save" AutoPostBack="true" runat="server"></asp:DropDownList>

                                                <%--<cc1:ComboBox ID="ddlAccountHead" 
                                                            CssClass="inpt autoCopleteBox relative_gt" 
                                                            runat="server" Width="250px"
                                                            placeholder="p"
                                                            DropDownStyle="Simple"  
                                    ...
                                    <div id="divItemData" runat="server">
                                        <table class="item_invoice_table  table-bordered">
                                            <tr>
                                                <td colspan="15" class="text-center inf_head">&nbsp;</td>
                                            </tr>
                                            <tr class="inf_head">
                                                ...
                                                <th class="c item_invoice_col5" rowspan="2">Difference<br />
                                                    Rate</th>
                                                <th class="c hidden item_invoice_col6" rowspan="2">Taxable
                                                    <br />
                                                    Amount</th>
                                                ...
                                                <th class="c item_invoice_col9 hidden">CGST</th>
                                                <th class="c item_invoice_col8">CGST</th>
                                                <th class="c item_invoice_col11  hidden">SGST</th>
                                                <th class="c item_invoice_col8">SGST</th>
                                                <th class="c item_invoice_col13 hidden">IGST</th>
                                                <th class="c item_invoice_col8">IGST</th>
                                                <th class="c item_invoice_col15  hidden">CESS</th>
                                                <th class="c item_invoice_col8">CESS</th>
                                                <th class="c item_invoice_col12" rowspan="2">Save</th>
                                            </tr>
                                            <tr class="inf_head">
                                                <th class="c hidden item_invoice_col9">Tax</th>
                                                <th class="c item_invoice_col8">Amount</th>
                                                <th class="c hidden item_invoice_col12">Tax</th>
                                                <th class="c item_invoice_col9">Amount</th>
                                                <th class="c hidden item_invoice_col13">Tax</th>
                                                <th class="c item_invoice_col10">Amount</th>
                                                <th class="c hidden item_invoice_col15">Tax</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="item_invoice_col3">
                                                    <asp:TextBox CssClass="Decimal4" ID="txtQty" runat="server" type="text" placeholder="Qty" OnTextChanged="txtQty_TextChanged" AutoPostBack="true" /></td>
                                                <td class="item_invoice_col4">
                                                    <asp:DropDownList CssClass="" ID="ddlUnit" runat="server" Enabled="false" /></td>
                                                <td class="item_invoice_col5">
                                                    <asp:TextBox CssClass="Money" ID="txtRate" runat="server" OnTextChanged="txtRate_TextChanged" type="text" placeholder="Rate" AutoPostBack="true" /></td>
                                                <td class="item_invoice_col6 hidden">
                                                    <asp:TextBox CssClass="Money" ID="txtTaxableAmt" runat="server" type="text" placeholder="Amount" /></td>
                                                <td class="item_invoice_col6">
                                                ...
                                                <td class="item_invoice_col9 hidden ">
                                                    <asp:TextBox CssClass="Money" ID="txtCGSTTax" runat="server" type="text" placeholder="Tax" /></td>
                                                ...
                                                <td class="item_invoice_col11 hidden ">
                                                    <asp:TextBox CssClass="Money" ID="txtSGSTTax" runat="server" type="text" placeholder="Tax" /></td>
                                                <td class="item_invoice_col9">
                                                    <asp:TextBox CssClass="Money" ID="txtSGSTAmt" runat="server" type="text" placeholder="Amount" Enabled="false" /></td>
                                                <td class="item_invoice_col13 hidden ">
                                                    <asp:TextBox CssClass="Money" ID="txtIGSTTax" runat="server" type="text" placeholder="Tax" /></td>
                                                ...
                                                <td class="item_invoice_col15 hidden ">
                                                    <asp:TextBox CssClass="Money" ID="txtCessTax" runat="server" type="text" placeholder="Tax" /></td>
                                                <td class="item_invoice_col1l">
                                                    <asp:TextBox CssClass="Money" ID="txtCessAmt" runat="server" type="text" placeholder="Amount" Enabled="false" /></td>
                                                <th class="item_invoice_col12 c">
                                                    <asp:LinkButton ID="btnSaveITEM" CssClass="btn btn-sxs btn-primary" OnClick="btnSaveITEM_Click" runat="server"><i class="fa r fa-floppy-o"></i>Save</asp:LinkButton></th>
                                            </tr>

                                        </table>
                                        <table class="item_invoice_table_gridview">
                                ...
                                <th class="c item_invoice_gridview_col6" rowspan="2" >Taxable <br />Amount</th>
                                ...
                                <th class="c item_invoice_gridview_col16">Amount</th>
                                            ...
                                            <%-- <tr>
                                <td class="item_invoice_gridview_col1" >Text</td>
                                <td class="item_invoice_gridview_col2" >Text</td>
                                <td class="item_invoice_gridview_col3" >Text</td>
                                <td class="item_invoice_gridview_col4" >Text</td>
                                <td class="item_invoice_gridview_col5" >Text</td>
                                <td class="item_invoice_gridview_col6" >Text</td>
                                <td class="item_invoice_gridview_col7" >Text</td>
                                <td class="item_invoice_gridview_col8" >Text</td>
                                <td class="item_invoice_gridview_col9" >Text</td>
                                <td class="item_invoice_gridview_col10">Text</td>
                                <td class="item_invoice_gridview_col11">Text</td>
                                <td class="item_invoice_gridview_col12">Text</td>

                                <td class="item_invoice_gridview_col13"> Text</td>
                                <td class="item_invoice_gridview_col14">Text</td>
                                <td class="item_invoice_gridview_col15">Text</td>
                                <td class="item_invoice_gridview_col16">Text</td>
                                <th class="item_invoice_gridview_col17 c"><a href="#" class="btn btn-sxs btn-info"><i class="fa r fa-pencil"></i> Edit</a></th>
                            </tr>
                                <tr>
                                <td class="item_invoice_gridview_col1" >Text</td>
                                <td class="item_invoice_gridview_col2" >Text</td>
                                ...
                                <th class="item_invoice_gridview_col17 c"><a href="#" class="btn btn-sxs btn-info"><i class="fa r fa-pencil"></i> Edit</a></th>
                                        ...
                                        <%--<asp:GridView ID="gvFinalItemDetail" CssClass="gstr_sales_item table-bordered" OnRowCommand="gvFinalItemDetail_RowCommand" AutoGenerateColumns="false" runat="server">
                                            <Columns>
                                        ...
                                        <asp:GridView ID="gvItemDetail" CssClass="table-bordered 2" AutoGenerateColumns="false" OnRowCommand="gvItemDetail_RowCommand" runat="server" Style="margin-top: 15px">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="HSN" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="HSNSACCode" />
                                                ...
                                                <asp:BoundField HeaderText="Unit" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="ItemUnit" />
                                                ...
                                                <asp:BoundField HeaderText="Taxable Amt" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="ItemAmt" />
                                                ...
                                                <asp:BoundField HeaderText="CGST Tax" HeaderStyle-CssClass="hidden inf_head" ItemStyle-CssClass="hidden " DataField="CGSTTax" />
                                                <asp:BoundField HeaderText="CGST Amt" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="CGSTTaxAmt" />
                                                <asp:BoundField HeaderText="SGST Tax" HeaderStyle-CssClass="hidden inf_head" ItemStyle-CssClass="hidden " DataField="SGSTTax" />
                                                <asp:BoundField HeaderText="SGST Amt" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="SGSTTaxAmt" />
                                                <asp:BoundField HeaderText="IGST Tax" HeaderStyle-CssClass="hidden inf_head" ItemStyle-CssClass="hidden " DataField="IGSTTax" />
                                                <asp:BoundField HeaderText="IGST Amt" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="IGSTTaxAmt" />
                                                <asp:BoundField HeaderText="CESS Tax" HeaderStyle-CssClass="hidden inf_head" ItemStyle-CssClass="hidden " DataField="CESSTax" />
                                                <asp:BoundField HeaderText="CESS Amt" HeaderStyle-CssClass="inf_head" ItemStyle-CssClass="" DataField="CESSTaxAmt" />
                                                ...
                                                <asp:TemplateField HeaderText="Edit" HeaderStyle-CssClass="inf_head">
                                                    <ItemTemplate>
                                    ...
                                    <table class="credit_amount_narration_table table-bordered">
                                        ...
                                        <tr>
                                            <td class="">
                                                ...
                                                <asp:TextBox ID="txtCrAmount" MaxLength="7" placeholder="Amount" runat="server" />
                                            </td>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <asp:Button ID="btnUpdate" runat="server" Text="Update" class="btn btn-primary btn-space-right" OnClick="btnUpdate_Click" Visible="false" />
