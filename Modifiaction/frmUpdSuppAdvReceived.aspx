<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmUpdSuppAdvReceived.aspx.cs" Inherits="Modifiaction_frmUpdSuppAdvReceived" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                ...
                <h3 class="text-center head">CUSTOMER ADVANCE RECEIVED UPDATION
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="amount_col1">
                                                    <asp:TextBox ID="txtGross" Enabled="false" runat="server" placeholder="Gross" CssClass="Money decimal2">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="pull-left">
                                            ...
                                            <asp:Button ID="btnCancel" Text="Cancel" runat="server" OnClick="btnCancel_Click" CssClass="btn btn-warning"  Visible="true"/>
                                        </div>
                                        <div class="pull-right">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" CssClass="btn btn-primary btn-space-right" Enabled="false"  Visible="true"/>
                                            <asp:Button ID="btnClear" runat="server" Text="Clear" OnClick="btnClear_Click" CssClass="btn btn-danger btn-space-right" />
                                        </div>
                                    </div>
                                </div>
                            </div>
