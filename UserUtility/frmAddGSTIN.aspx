<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MainMaster.master" CodeFile="frmAddGSTIN.aspx.cs" Inherits="UserUtility_frmAddGSTIN" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center" style="padding: 5px">ADD GSTIN
                </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <asp:DropDownList ID="ddlState" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlState_SelectedIndexChanged" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="divDefault" class="hidden">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="pnlbtnAdd" class="col-md-3">
                                                        <br />
                                                        <asp:Button ID="btnAddSeries" CssClass="btn btn-primary btn-sm" Text="Add" OnClick="btnAddSeries_Click" OnClientClick="return SeriesValidation()" runat="server" />
                                                        <asp:Button ID="btnClearSeries" CssClass="btn btn-danger btn-sm" Text="Clear" OnClick="btnClearSeries_Click" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-12">
