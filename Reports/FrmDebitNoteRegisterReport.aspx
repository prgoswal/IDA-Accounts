<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="FrmDebitNoteRegisterReport.aspx.cs" Inherits="FrmDebitNoteRegisterReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" style="height: 75%">
        <h3 class="text-center head">Debit Note Register</h3>
                    ...
                    <div class="panel-body">
                        <div class="col-xs-12">
                            <table class="pdf_show">
                                <tr>
                                    <td class="pdf_show_col1 r pr">Select Type</td>
                                    <td  style="width:9%">
                                        <style>
                                            .select_reset {
                                        ...
                                        <asp:DropDownList ID="ddl" runat="server" CssClass="select_reset">
                                            <asp:ListItem Text="Debit Note Financial" Value="0" />
                                            <asp:ListItem Text="Debit Note Against Invoice" />
                                        </asp:DropDownList>
                                    </td>
