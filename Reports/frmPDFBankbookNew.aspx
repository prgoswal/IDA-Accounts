<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmPDFBankbookNew.aspx.cs" Inherits="frmPDFBankbook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" style="height: 75%">
        <h3 class="text-center head">Bank Book 
        </h3>
                        ...
                        <div class="col-xs-12">
                            <table class="pdf_show">
                                <tr>
                                    ...
                                    <td class="pdf_show_col5 r pr">Bank Head</td>
                                        ...
                                        <div id="divPartySelect" runat="server">
                                            ...
                                            <div id="divdrop" class="collapse pos-abs" style="max-height: 220px; overflow-y: scroll">
                                                <div>
                                                    ...
                                                    <asp:CheckBoxList ID="ddlBankAccount" runat="server"></asp:CheckBoxList>
                                                </div>
                                            </div>
                                        </div>
