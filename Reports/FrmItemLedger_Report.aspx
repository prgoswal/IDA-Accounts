<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="FrmItemLedger_Report.aspx.cs" Inherits="Reports_FrmItemLedger_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" style="height: 75%">
        <h3 class="text-center head">Stock Ledger
        </h3>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div style="text-align: center">
                                    <asp:Label Style="" CssClass="text-danger" ID="lblErrorMsg" runat="server" />
