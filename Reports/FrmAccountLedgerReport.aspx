<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="FrmAccountLedgerReport.aspx.cs" Inherits="FrmAccountLedgerReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" style="height: 75%">
        <h3 class="text-center head">Account Ledger 
        </h3>
                        ...
                        <div class="col-xs-12">
                            <table class="pdf_show">
                                <tr>
                                    ...
                                    <td class="pdf_show_col5 r pr">Head Name</td>
                                    <td class="pdf_show_col6" style="width: 26.6%">
                                        <%--<cc1:ComboBox ID="ddlAccountHead" runat="server" Width="250px" AutoPostBack="true" OnSelectedIndexChanged="ddlAccountHead_SelectedIndexChanged" placeholder="p" CssClass="relative_gt" DropDownStyle="Simple" AutoCompleteMode="SuggestAppend" CaseSensitive="False" Style="text-transform: uppercase"></cc1:ComboBox>--%>

                                           <asp:DropDownList runat="server" ID="ddlAccountHead" OnSelectedIndexChanged="ddlAccountHead_SelectedIndexChanged" AutoPostBack="true" CssClass="chzn-select">
                                     </asp:DropDownList>
                                    </td>
                            ...
                            <div style="text-align: center">
                                <asp:Label Style="font-weight: bold; color: #f05050;; font-size: medium" ID="lblErrorMsg" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
