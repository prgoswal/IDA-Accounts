...
public partial class Reports_FrmCash_SalesRegister_Report : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Session["Report"] = "RptCashSalesRegister";//Report Name
            ...
            HT.Add("ReportHeading", "CASH SALES REGISTER ");

            HT.Add("cashsalesind", 2);
            HT.Add("invoiceno", 0);
            HT.Add("invoiceDate", "2017/05/01");
            HT.Add("Doctype", 6);
            ...
            Session["HT"] = HT;
            Session["format"] = "Pdf";
            Session["FileName"] = "CashSalesRegister";
