            ...
            <ContentTemplate>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-HoriZontal"> 
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <asp:CheckBox ID="ChkCostCenter" runat="server" Text="Cost-Center(SubSection) Concept Is Taken" />
                ...
                <style>
                    .bodyPop {
                        ...
                        padding 15px . wi he ght:;
                    }

                    .rpotPopUp width: 00%; p: 0px; t padding-top:220px; background-color: rgba(0, 0, 0, 0.63); position: fixed; z-index: 1940;
                    }
                </style>
            </ContentTemplate>
            <Triggers>
