<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmCashPayment.aspx.cs" Inherits="frmCashPayment" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">CASH PAYMENT
                                ...
                                <div class="col-sm-12">
                                    <table class="cashpayment_table1 table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 10%">
                                                ...
                                                <asp:RequiredFieldValidator ID="ReqtxtVoucherDate" runat="server" ControlToValidate="txtVoucherDate" ErrorMessage="Enter Transaction Date!" ValidationGroup="btnsave" Display="Dynamic" CssClass="gst-ac-error"></asp:RequiredFieldValidator>
                                            </td>
                                    ...
                                    <table id="tbl_id" class="cashpayment_table2 table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <%-- <td></td>
                                                <th class="inf_head c b">
                                                    <asp:Label ID="lblPartyName" runat="server" Text="Party Name"></asp:Label>
                                                </th>
                                                <td colspan="5">
                                                    <asp:TextBox ID="txtPartyName" placeHolder="Party Name" runat="server"></asp:TextBox>
                                                </td>
                                                <td></td>--%>
                                                <td></td>
                                            </tr>
                                    ...
                                    <asp:GridView ID="gvCashPayment" CssClass="cashpayment_table2_grid table-bordered" AutoGenerateColumns="false" runat="server" ShowHeader="false" OnRowCommand="gvCashPayment_RowCommand">
                                        <Columns>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <asp:Button ID="btnSave" ValidationGroup="btnsave" OnClick="btnSave_Click" runat="server" Text="Save" CssClass="btn btn-primary btn-space-right" />
