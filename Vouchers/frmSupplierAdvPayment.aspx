<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmSupplierAdvPayment.aspx.cs" Inherits="Vouchers_frmSupplierAdvPayment" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                ...
                <h3 class="text-center head">SUPPLIER ADVANCE PAYMENT 
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <table class=" table-bordered table_sar mb20" style="margin-bottom:10px">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <asp:DropDownList ID="ddlCashBankAccount" CssClass="Required" OnSelectedIndexChanged="ddlCashBankAccount_SelectedIndexChanged" AutoPostBack="true" placeholder="Select Cash/Bank Account" data-group="Save" Style="width: 100%" runat="server"></asp:DropDownList>
                                            </td>
                                            <td class="">
                                                <asp:DropDownList ID="txtAccountHead" CssClass="chzn-select pull-left" runat="server" AutoPostBack="true" OnSelectedIndexChanged="txtAccountHead_SelectedIndexChanged">
                                                </asp:DropDownList>
                                    ...
                                    <div id="divGrid" runat="server" style="max-height: 134px; overflow-y: scroll; margin-bottom: 20px">
                                        <asp:GridView ID="grditemTax" runat="server" AutoGenerateColumns="false" OnRowCommand="grditemTax_RowCommand" CssClass="table-gstr table-bordered" Style="width: 100%">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass=" text-center" ItemStyle-Width="4%">
                                                    <ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="pull-right">
                                            ...
                                            <asp:Button ID="btnClear" runat="server" OnClick="btnClear_Click" Text="Clear" class="btn btn-danger btn-space-right" />
                                        </div>
