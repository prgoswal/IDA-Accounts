<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MainMaster.master" CodeFile="frmPurchaseReturn.aspx.cs" Inherits="Vouchers_frmPurchaseReturn" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">PURCHASE RETURN
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <table class="table table-voucher table-bordered table-form gstr_sales_item" id="addtothis" style="margin-bottom: 80px;">
                                        ...
                                        <tbody>
                                            <tr class="form-tr">
                                                <td>
                                                    <cc1:ComboBox ID="ddlExpenseHead" AutoPostBack="true" OnSelectedIndexChanged="ddlExpenseHead_SelectedIndexChanged" Enabled="false" runat="server" Width="250px" placeholder="p" CssClass="relative_gt" AutoCompleteMode="SuggestAppend" CaseSensitive="False" Style="text-transform: uppercase"></cc1:ComboBox>
                                                </td>
                                                <td>
                                                    <cc1:ComboBox ID="ddlItemName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlItemName_SelectedIndexChanged" Enabled="false" Width="20px" placeholder="p" CssClass="relative_gt" AutoCompleteMode="SuggestAppend" CaseSensitive="False" Style="text-transform: uppercase"></cc1:ComboBox>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtFree" MaxLength="8" CssClass="Decimal4" runat="server" Enabled="false" OnTextChanged="txtFree_TextChanged" AutoPostBack="true" Text="0"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txtRate" MaxLength="9" runat="server" Text="0" CssClass="Money" Enabled="false" OnTextChanged="txtRate_TextChanged" AutoPostBack="true"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txtItemAmt" MaxLength="9" Enabled="false" runat="server" Text="0" CssClass="Money"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txtDiscount" MaxLength="9" runat="server" Enabled="false" CssClass="Money" Text="0" OnTextChanged="txtDiscount_TextChanged" AutoPostBack="true"></asp:TextBox></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlEdit" runat="server" AutoPostBack="true" Enabled="false" OnSelectedIndexChanged="ddlEdit_SelectedIndexChanged" Style="font-size: 12px; padding: 0">
                                            ...
                                            <tr id="collapse_me_tr">
                                                ...
                                                <td style="width: 80px; position: relative; text-align: center; border-bottom-color: transparent; border-right-color: transparent">
                                                    ...
                                                    <div style="position: absolute; top: -54px; left: 50%; transform: translateX(-50%);">
                                                        ...
                                                        <asp:Button ID="btnAddItemDetail" CssClass="btn btn-xs btn-primary" Enabled="false" Text="Add" OnClick="btnAddItemDetail_Click" runat="server" />
                                                    </div>
                                                </td>
                                    ...
                                    <div id="divScroll" runat="server" style="margin-bottom: 20px; overflow: auto;">
                                        ...
                                        <asp:GridView ID="grdFinalItemDetails" HeaderStyle-CssClass="hidden" CssClass="table table-voucher table-bordered table-form gstr_sales_item first_tr_hide" AutoGenerateColumns="false" ShowHeader="True" OnRowCommand="grdFinalItemDetails_RowCommand" OnRowDataBound="grdFinalItemDetails_RowDataBound" runat="server">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <tr>
                                        ...
                                        <asp:GridView ID="grdItemDetails" HeaderStyle-CssClass="hidden" CssClass="table table-voucher table-bordered table-form gstr_sales_item first_tr_hide" OnRowCommand="grdItemDetails_RowCommand" OnRowDataBound="grdItemDetails_RowDataBound" AutoGenerateColumns="false" runat="server" ShowHeader="True">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <tr>
                                                            <th colspan="20" class="inf_head">Existing Items</th>
                                                        </tr>
                                                        <tr>
                                                            <th rowspan="2" class="inf_head" style="width: 12%;">Expense Head</th>
                                                            <th rowspan="2" class="inf_head" style="width: 13%;">Item Name</th>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="pull-right">
                                            ...
                                            <asp:Button ID="btnSave" OnClick="btnSave_Click" runat="server" Text="Save" Enabled="false" CssClass="btn btn-primary btn-space-right" />
