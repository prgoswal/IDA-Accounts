...
public partial class frmSales : System.Web.UI.Page
{
    ...
    void BindAll()
    {
        ...
        string uri = string.Format("SalesVauchar/BindAll");
        ...
        if (dsBindAll.Tables.Count > 0)
        {
            ...
            if (VsItemNameList.Rows.Count <= 0 && VsdtSalesTo.Rows.Count <= 0)
            {
                ...
                CommonCls.ShowModal("Please Open Party Accounts & Item.  Press Yes For Open Party Accounts.", false, "../AdminMasters/frmAccountHead.aspx");
                return;
            }
            ...
            {
                txtInvoiceSeries.Visible = false;
                CommonCls.ShowModal("Please Open Item. Press Yes For Open Item Group", false, "../AdminMasters/frmGroupMaster.aspx");
                return;
            }
            ...
            {
                txtInvoiceSeries.Visible = false;
                CommonCls.ShowModal("Please Open  Party Accounts. Press Yes For Open Party Accounts.", false, "../AdminMasters/frmAccountHead.aspx");
                return;
            }
            ...
            if (VsdtSalesTo.Rows.Count > 0)
            {
                ...
                ddlSalesto.DataBind();
                //ddlSalesto.Items.Insert(0, new ListItem("-- Select --", "0"));
            ...
            {
                txtInvoiceSeries.Visible = false;
                CommonCls.ShowModal("Your Invoice Series Not Set. Press Yes For Setting Invoice Series.", false, "../Modifiaction/frmUpdateProfileCreation.aspx");
                return;
            }
    ...
    protected void ddlSalesto_SelectedIndexChanged1(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjSaleModel.AdvRecPayID = 13;

            //string uri = string.Format("SalesVauchar/FillGistnNo");
            string uri = string.Format("SalesVauchar/FillGistnNoWithDetail");
            DataSet dsGSTINWithDetail = CommonCls.ApiPostDataSet(uri, ObjSaleModel);
    ...
    void FillShippingAddress()
    {
        ...
        string uri = string.Format("SalesVauchar/FillShippingAddress");
    ...
    void Filllocation()
    {
        try
        {
            ...
            string uri = string.Format("SalesVauchar/Filllocation");
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)// Fill Record Item List
    {
        try
        {
            ...
            ObjSaleModel.ItemID = CommonCls.ConvertIntZero(ddlItemName.SelectedValue);
            ...
            string uri = string.Format("SalesVauchar/FillItemSellRate");
            ...
            if (dsItems.Tables[0].Rows.Count > 0)
            {
                ...
                if (GlobalSession.StockMaintaineByMinorUnit)
                {
                    ...
                    {
                        txtMinorUnitQty.Text = "";//CommonCls.ConvertDecimalZero(VsdtItems.Rows[0]["ItemMinorUnitQty"]).ToString();
                        txtMinorUnitQty.Enabled = true;//false;
                    }
                    else
                    {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjSaleModel.WareHouseID = Convert.ToInt32(ddlLocation.SelectedValue);
            ...
            ObjSaleModel.DtAdjAdvance = CreateAdvanceDt();
            ...
            string uri = string.Format("SalesVauchar/SaveSalesVoucher");
    ...
    void ClearAll()
    {
        ...
        txtFree.Text = txtQty.Text = txtRate.Text = txtItemAmt.Text = txtDiscount.Text = txtItemTaxableAmt.Text = "0";
    ...
    void CallReport(string InvoiceNo, string InvoiceDate, string InvoiceName, string InvoiceSeries, string LastVNO)
    {
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjSaleModel.ByCashSale = 0;
            ObjSaleModel.PartyName = "";
            ObjSaleModel.PartyGSTIN = "";

            ObjSaleModel.PartyAddress = "";

            ObjSaleModel.WareHouseID = 0;
            ObjSaleModel.TransName = "";
            ObjSaleModel.PONo = "0";
            ...
            ObjSaleModel.DtSales = CreateSaleDataCancel();

            DataRow drItems = ObjSaleModel.DtItems.NewRow();
            drItems["ItemName"] = "";
            drItems["ItemName"] = "";
            drItems["ItemUnit"] = "";
            ...
            drItems["ItemRemark"] = "";
            drItems["ExtraInd"] = 0;
            ObjSaleModel.DtItems.Rows.Add(drItems);


            string uri = string.Format("SalesVauchar/CancelSalesVoucherNo");
            DataTable dtSave = CommonCls.ApiPostDataTable(uri, ObjSaleModel);
            if (dtSave.Rows.Count > 0)
            {
                if (dtSave.Rows[0]["ReturnInd"].ToString() == "1")
