<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmCreditNote.aspx.cs" Inherits="frmCreditNote" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">CREDIT NOTE
                                ...
                                <div class="col-xs-12">
                                    <table class="credit_table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <asp:DropDownList ID="ddlPartyAccount" CssClass="chzn-search Required" data-group="Save" AutoPostBack="true" OnSelectedIndexChanged="ddlPartyAccount_SelectedIndexChanged" runat="server"></asp:DropDownList>
                                    ...
                                    <table class="original_invoice_table  table-bordered" style="margin-left: 10px; float: right; margin-bottom: 25px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="ddlAccountHead" CssClass="chzn-search Required" data-group="Save" runat="server"></asp:DropDownList>
                                        ...
                                        <table class="item_invoice_table  table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td class="item_invoice_col3">
                                                    <asp:TextBox CssClass="Decimal4" ID="txtQty" runat="server" type="text" placeholder="Qty" AutoPostBack="true" OnTextChanged="txtQty_TextChanged" /></td>
                                ...
                                <th class="item_invoice_gridview_col17 c"><a href="#" class="btn btn-sxs btn-info"><i class="fa r fa-pencil"></i> Edit</a></th>
                                        ...
                                        <asp:GridView ID="gvItemDetail" CssClass="table-bordered 2" AutoGenerateColumns="false" OnRowCommand="gvItemDetail_RowCommand" runat="server" Style="margin-top: 15px">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="IncomeExpenseCode" HeaderStyle-CssClass="hidden inf_head" ItemStyle-CssClass="hidden" DataField="IncomeExpenseCode" />
