<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmStockTransfer.aspx.cs" Inherits="Vouchers_frmStockTransfer" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">STOCK TRANSFER/MOVEMENT
                                        ...
                                        <table class="table table-voucher gstr_sales_invoice table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ti_col3">
                                                        <asp:DropDownList ID="ddlTransferFrom" AutoPostBack="true" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" runat="server">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td class="ti_col4">
                                                        <asp:DropDownList ID="ddlTransferTo" AutoPostBack="true" OnSelectedIndexChanged="ddlTransferTo_SelectedIndexChanged" runat="server">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <%--<td class="ti_col5">
                                                ...
                                                <tr id="trCCCode" runat="server" visible="false">
                                                    ...
                                                    <td class="ti_col3">Cost Centre Transfer From    
                                                        <asp:DropDownList ID="ddlCCCodeFrom" AutoPostBack="true" runat="server">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td class="ti_col4">Cost Centre Transfer To    
                                                        <asp:DropDownList ID="ddlCCCodeTo" AutoPostBack="true" runat="server">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table table-voucher table-bordered table-form gstr_sales_item tdb0">
                                            ...
                                            <tbody>
                                                <tr class="align_with_combobox">
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnAddItemDetail" CssClass="btn btn-xs btn-primary add_btn" Text="Add" Enabled="false" OnClick="btnAddItemDetail_Click" runat="server" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
