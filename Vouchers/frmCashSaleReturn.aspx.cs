...
public partial class Vouchers_frmCashSaleReturn : System.Web.UI.Page
{
    CashSaleReturnModel objCashSalesReturnModel = new CashSaleReturnModel();
    ...
    private void BindCancelReason()
    {
        try
        {
            objCashSalesReturnModel = new CashSaleReturnModel();
            objCashSalesReturnModel.Ind = 100;
            string uri = string.Format("Master/Master");
            DataTable dtCancelReason = CommonCls.ApiPostDataTable(uri, objCashSalesReturnModel);
    ...
    {
        objCashSalesReturnModel = new CashSaleReturnModel();
        objCashSalesReturnModel.Ind = 11;
        objCashSalesReturnModel.OrgID = GlobalSession.OrgID;
        objCashSalesReturnModel.BrID = GlobalSession.BrID;
        objCashSalesReturnModel.YrCD = GlobalSession.YrCD;
        objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        objCashSalesReturnModel.ByCashSale = 1;
        string uri = string.Format("CashSaleReturn/BindAll");
        DataSet dsBindAll = CommonCls.ApiPostDataSet(uri, objCashSalesReturnModel);
    ...
    void FillGSTIN()
    {
        ...
        objCashSalesReturnModel = new CashSaleReturnModel();
        objCashSalesReturnModel.Ind = 1;
        objCashSalesReturnModel.OrgID = GlobalSession.OrgID;
        objCashSalesReturnModel.BrID = GlobalSession.BrID;
        objCashSalesReturnModel.YrCD = GlobalSession.YrCD;
        objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        objCashSalesReturnModel.AccCode = CommonCls.ConvertIntZero(ddlPartyName.SelectedValue);

        string uri = string.Format("CashSaleReturn/FillGistnNo");
        DataTable dtGSTIN = CommonCls.ApiPostDataTable(uri, objCashSalesReturnModel);
    ...
    {
        objCashSalesReturnModel = new CashSaleReturnModel();
        objCashSalesReturnModel.Ind = 4;
        objCashSalesReturnModel.OrgID = GlobalSession.OrgID;
        objCashSalesReturnModel.BrID = GlobalSession.BrID;
        objCashSalesReturnModel.YrCD = GlobalSession.YrCD;
        objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        objCashSalesReturnModel.AccCode = CommonCls.ConvertIntZero(ddlPartyName.SelectedValue);
        objCashSalesReturnModel.GSTIN = ddlGstinNo != null ?
                 ddlGstinNo.Items.Count > 0 && !string.IsNullOrEmpty(ddlGstinNo.SelectedValue) ?
                 ddlGstinNo.SelectedValue : "" : "";

        string uri = string.Format("CashSaleReturn/FillShippingAddress");
        DataTable dtShipping = CommonCls.ApiPostDataTable(uri, objCashSalesReturnModel);
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            try
            {
                ...
                {
                    objCashSalesReturnModel = new CashSaleReturnModel();
                    objCashSalesReturnModel.Ind = 15;
                    string uriGSTIn = string.Format("Master/Master");
                    DataTable dtState = CommonCls.ApiPostDataTable(uriGSTIn, objCashSalesReturnModel);
            ...
            objCashSalesReturnModel.BrID = GlobalSession.BrID;
            objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
            objCashSalesReturnModel.ItemID = CommonCls.ConvertIntZero(GvRow.ddlItemName.SelectedValue);

            if (!string.IsNullOrEmpty(ddlGstinNo.Text))
                objCashSalesReturnModel.GSTIN = ddlGstinNo.SelectedValue;
            objCashSalesReturnModel.PartyState = CommonCls.ConvertIntZero(ddlState.SelectedValue);

            objCashSalesReturnModel.ByCashSale = 1;

            string uri = string.Format("CashSaleReturn/FillItemSellRate");
            DataSet dsSaleRate = CommonCls.ApiPostDataSet(uri, objCashSalesReturnModel);
    ...
    protected void ddlFreeItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        objCashSalesReturnModel.BrID = GlobalSession.BrID;
        objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
        objCashSalesReturnModel.ItemID = CommonCls.ConvertIntZero(ddlFreeItemName.SelectedValue);
        objCashSalesReturnModel.ByCashSale = 1;
    ...
    protected void btnSearchInvoice_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCashSalesReturnModel = new CashSaleReturnModel();
            objCashSalesReturnModel.Ind = 2;
            objCashSalesReturnModel.OrgID = GlobalSession.OrgID;
            objCashSalesReturnModel.BrID = GlobalSession.BrID;
            objCashSalesReturnModel.YrCD = GlobalSession.YrCD;
            objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
            objCashSalesReturnModel.InvoiceNo = CommonCls.ConvertIntZero(txtSearchInvoice.Text);

            switch (CommonCls.ConvertIntZero(VsdtSeries.Rows[0]["SeriesType"]))
            {
                case 1: /// Manual Series
                    objCashSalesReturnModel.InvoiceSeries = "";//txtInvoiceSeriesFind.Text;
                    break;
                ...
                case 2: /// Available Series
                    ...
                    objCashSalesReturnModel.InvoiceSeries = ddlInvoiceSeriesFind.SelectedItem.Text;
                    break;
            ...
            string uri = string.Format("CashSaleReturn/SearchSaleInvoice");
            DataSet dsSearchInvoice = CommonCls.ApiPostDataSet(uri, objCashSalesReturnModel);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCashSalesReturnModel.YrCD = GlobalSession.YrCD;
            objCashSalesReturnModel.VchType = Convert.ToInt32(ViewState["VchType"]);
            objCashSalesReturnModel.User = GlobalSession.UserID;
            objCashSalesReturnModel.IP = GlobalSession.IP;

            objCashSalesReturnModel.EntryType = 1;

            objCashSalesReturnModel.ByCashSale = 1;

            //DataTable dtadv = CreateAdvanceDt();
            //dtadv.TableName = "dtadv";
            //objCashSalesReturnModel.ds.Tables.Add(dtadv); 

            objCashSalesReturnModel.DtAdjAdvance = CreateAdvanceDt();

            //ObjSaleModel.InvoiceSeries = txtInvoiceSeries.Text;
            switch (CommonCls.ConvertIntZero(VsdtSeries.Rows[0]["SeriesType"]))
            {
                case 1: /// Manual Series
                    objCashSalesReturnModel.InvoiceSeries = txtInvoiceSeries.Text.ToUpper();
                    break;

                case 2: /// Available Series
                    objCashSalesReturnModel.InvoiceSeries = ddlInvoiceSeries.SelectedItem.Text;
                    break;
            ...
            //objCashSalesModel.InvoiceSeries = "CASH";
            objCashSalesReturnModel.PartyName = ddlPartyName.SelectedItem == null ? "" : ddlPartyName.SelectedItem.Text; //txtPartyDetailPartyName.Text;
            objCashSalesReturnModel.PartyMobileNo = CommonCls.ConvertLongZero(txtPartyDetailMobileNo.Text);
            objCashSalesReturnModel.PartyGSTIN = ddlGstinNo.Text.ToUpper();
            objCashSalesReturnModel.PayMode = ddlPaymentMode.SelectedItem.Text;
            objCashSalesReturnModel.PayModeRemark = txtPMRemark.Text;

            objCashSalesReturnModel.PartyAddress = ddlShippingAdd.SelectedItem == null ? "" : ddlShippingAdd.SelectedItem.Text; //ddlIncomeHead.SelectedValue == CashSalesAcc ? txtShippingAdd.Text.ToUpper() :
            //ddlShippingAdd.SelectedItem != null ? ddlShippingAdd.SelectedItem.Text.ToUpper() : "";

            objCashSalesReturnModel.CCCode = CommonCls.ConvertIntZero(ddlCostCenter.SelectedValue);

            objCashSalesReturnModel.WareHouseID = CommonCls.ConvertIntZero(ddlLocation.SelectedValue);
            objCashSalesReturnModel.PONo = "";

            objCashSalesReturnModel.BrokerageID = CommonCls.ConvertIntZero(ddlBroker.SelectedValue);
            objCashSalesReturnModel.BrokerageRate = CommonCls.ConvertDecimalZero(txtBrokerRate.Text);
            objCashSalesReturnModel.BrokerageGSTIN = string.IsNullOrEmpty(ddlBrokerGSTIN.SelectedValue) ? "" : ddlBrokerGSTIN.SelectedValue;

            objCashSalesReturnModel.BrokerageAmount = CommonCls.ConvertDecimalZero(txtBrokerAmount.Text);

            objCashSalesReturnModel.TransName = txtTransportationName.Text;
            objCashSalesReturnModel.PartyState = CommonCls.ConvertIntZero(ddlState.SelectedValue);


            objCashSalesReturnModel.DtCashSales = DtCashSalesSchema();
            objCashSalesReturnModel.DtItems = DtItemsSchema();
            objCashSalesReturnModel.DtSundries = DtSundriesSchema();

            objCashSalesReturnModel.DtCashSales = CreateCashSalesData();
            ...
            VsdtGvItemDetail = VsdtGvItemDetail.Select("ItemID<>0").CopyToDataTable();
            objCashSalesReturnModel.DtItems = VsdtGvItemDetail;
            objCashSalesReturnModel.DtSundries = VsdtSundri;
            if ((objCashSalesReturnModel.DtSundries == null) || (objCashSalesReturnModel.DtSundries.Rows.Count == 0))
            {
                objCashSalesReturnModel.DtSundries = DtSundriesSchema();
                DataRow drSaleSundri = objCashSalesReturnModel.DtSundries.NewRow();
                drSaleSundri["SundriCode"] = 0;
                drSaleSundri["SundriHead"] = "0";
                drSaleSundri["SundriInd"] = "0";
                drSaleSundri["SundriAmt"] = 0;
                objCashSalesReturnModel.DtSundries.Rows.Add(drSaleSundri);
            }


            //Use Data Set For Avoide Null Value..!

            //DataTable DtCashSales = DtCashSalesSchema();
            //objCashSalesReturnModel.ds.Tables.Add(DtCashSales);

            ////DataTable DtItems = DtItemsSchema();
            ////objCashSalesReturnModel.ds.Tables.Add(DtItems);

            ////DataTable DtSundries = DtSundriesSchema();
            ////objCashSalesReturnModel.ds.Tables.Add(DtSundries);
            ////DataTable DtCashSales = CreateCashSalesData();
            ////objCashSalesReturnModel.ds.Tables.Add(DtCashSales) ;
            ...
            //DataTable DtSundries = new DataTable();
            //DtSundries = VsdtSundri;
            //if ((DtSundries == null) || (DtSundries.Rows.Count == 0))
            //{
            //    DtSundries = DtSundriesSchema();
            //    DataRow drSaleSundri = DtSundries.NewRow();
            //    drSaleSundri["SundriCode"] = 0;
            //    drSaleSundri["SundriHead"] = "0";
            //    drSaleSundri["SundriInd"] = "0";
            //    drSaleSundri["SundriAmt"] = 0;
            //    DtSundries.Rows.Add(drSaleSundri);
            //}
            //objCashSalesReturnModel.ds.Tables.Add(DtSundries); 
            if (objCashSalesReturnModel.DtItems != null)
            {
                if (objCashSalesReturnModel.DtItems.Columns.Contains("CCCode"))
                {
                    objCashSalesReturnModel.DtItems.Columns.Remove("CCCode");
                }
            }



            string uri = string.Format("CashSaleReturn/SaveCashSalesVoucher");
            DataTable dtSaveCashSales = CommonCls.ApiPostDataTable(uri, objCashSalesReturnModel);
            if (dtSaveCashSales.Rows.Count > 0)
            {
                if (dtSaveCashSales.Rows[0]["ReturnInd"].ToString() == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(objCashSalesReturnModel.InvoiceSeries))
                        InvoiceSeries = objCashSalesReturnModel.InvoiceSeries + "-";
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCashSalesReturnModel = new CashSaleReturnModel();
            objCashSalesReturnModel.Ind = 12;
            objCashSalesReturnModel.OrgID = GlobalSession.OrgID;
            objCashSalesReturnModel.BrID = GlobalSession.BrID;
            objCashSalesReturnModel.VchType = 6;//DocNo = 6;
            objCashSalesReturnModel.InvoiceSeries = ddlInvoiceSeriesFind.SelectedItem.Text;
            objCashSalesReturnModel.InvoiceNo = Convert.ToInt32(txtinvoiceNo.Text);
            objCashSalesReturnModel.CancelReason = ddlCancelReason.SelectedItem.Text;

            string uri = string.Format("UpdateCashSales/CancelVoucher");
            DataTable dtSave = CommonCls.ApiPostDataTable(uri, objCashSalesReturnModel);
            if (dtSave.Rows.Count > 0)
            {
                if (dtSave.Rows[0]["ReturnInd"].ToString() == "1")
                {
                    ClearAll();
                    pnlConfirmInvoice.Visible = false;
                    ShowMessage("Invoice No. - " + objCashSalesReturnModel.InvoiceNo + " is Cancel successfully ", true);
                }
                else if (dtSave.Rows[0]["ReturnInd"].ToString() == "0")
                {
                    pnlConfirmInvoice.Visible = false;
                    ShowMessage("Vouchar is not Cancel for Invoice No. " + objCashSalesReturnModel.InvoiceNo, true);
    ...
    protected void ddlBroker_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                objCashSalesReturnModel = new CashSaleReturnModel();
                objCashSalesReturnModel.Ind = 7;
                objCashSalesReturnModel.OrgID = GlobalSession.OrgID;
                objCashSalesReturnModel.BrID = GlobalSession.BrID;
                objCashSalesReturnModel.AccCode = CommonCls.ConvertIntZero(ddlBroker.SelectedValue);
                string uri = string.Format("UpdateCashSales/FillBrokerDetail");
                DataSet dsBrokerGSTINDetail = CommonCls.ApiPostDataSet(uri, objCashSalesReturnModel);
