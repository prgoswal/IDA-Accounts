<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MainMaster.master" CodeFile="frmPurchase.aspx.cs" Culture="hi-IN" Inherits="frmPurchase" %>
                        ...
                        <div class="panel panel-default pmb0">
                            <div class="panel-body">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <table class="table table-voucher table-bordered table-form gstr_sales_item gstr_purchase_voucher" style="width: 100%;">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width: 9%"><b>Transaction Date</b></td>
                                                <td style="width: 10%">
                                                    <asp:TextBox ID="txtVoucherDate" MaxLength="10" CssClass="datepicker" placeholder="DD/MM/YYYY" runat="server" />

                                                    <asp:RequiredFieldValidator ID="ReqtxtVoucherDate" runat="server" ControlToValidate="txtVoucherDate" ErrorMessage="Please Enter Transaction Date." ValidationGroup="btnsave" Display="Dynamic" CssClass="gst-ac-error"></asp:RequiredFieldValidator>


                                                </td>
                                                <td id="thCCCode" visible="false" style="width: 6%" runat="server"><b>Cost Centre</b></td>
                                                <td id="tdCCCode" visible="false" style="width: 50%" runat="server">
                                                    <asp:DropDownList ID="ddlCostCenter" runat="server"></asp:DropDownList>


                                                    <asp:RequiredFieldValidator ID="ReqddlCostCenter" runat="server" ControlToValidate="ddlCostCenter" ErrorMessage="Please Select Cost Centre." InitialValue="0" ValidationGroup="btnsave" Display="Dynamic" CssClass="gst-ac-error"></asp:RequiredFieldValidator>
                                                </td>

                                                <td style="width: 8%"><b>IDA Ref. No.</b></td>
                                                <td style="width: 17%">
                                                    <asp:TextBox ID="txtIDARefNo" MaxLength="9" runat="server" /></td>
                                    ...
                                    <table class="table table-voucher table-bordered table-form gstr_sales_item gstr_purchase_voucher">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtBillNo" MaxLength="16" placeholder="Bill No." runat="server"></asp:TextBox>


                                                    <asp:RequiredFieldValidator ID="ReqtxtBillNo" runat="server" ControlToValidate="txtBillNo" ErrorMessage="Please Enter Bill No." ValidationGroup="btnsave" Display="Dynamic" CssClass="gst-ac-error"></asp:RequiredFieldValidator>

                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtBillDate" CssClass="datepicker" MaxLength="10" placeholder="DD/MM/YYYY" Style="width: 100%" runat="server" />

                                                    <asp:RequiredFieldValidator ID="ReqtxtBillDate" runat="server" ControlToValidate="txtBillDate" ErrorMessage="Enter Bill Date." ValidationGroup="btnsave" Display="Dynamic" CssClass="gst-ac-error"></asp:RequiredFieldValidator>

                                                </td>
                                                <td>
                                                    <%--<asp:DropDownList ID="ddlPurchaseFrom" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPurchaseFrom_SelectedIndexChanged"></asp:DropDownList>--%>
                                                ...
                                                <td>
                                                    <%--<cc1:ComboBox ID="ddlGstinNo" AutoPostBack="true" CssClass="relative_gt" AutoCompleteMode="SuggestAppend" OnSelectedIndexChanged="ddlGstinNo_SelectedIndexChanged" runat="server" />--%>
                                        ...
                                        <table class="table table-voucher gstr_sales_invoice_2 table-bordered" style="margin-top: 20px">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ti_col5">
                                                        <asp:TextBox ID="txtGRNDate" CssClass="datepicker" MaxLength="10" Enabled="false" placeholder="DD/MM/YYYY" runat="server" /></td>
                                                    <td class="ti_col4">
                                    ...
                                    <table class="table table-voucher table-bordered table-form gstr_sales_item" id="addtothis" style="margin-bottom: 80px;">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2" style="width: 5%">Net Amount</th>
                                                <th rowspan="2" style="width: 7%">Discount<br />
                                                    <%--<span style="font-size: 11px">(% / Amt.)</span>--%>
                                                ...
                                                <th rowspan="2" style="width: 2%">Edit</th>
                                        ...
                                        <tbody>
                                            <tr class="form-tr">
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="ReqddlExpenseHead" runat="server" ControlToValidate="ddlExpenseHead" ErrorMessage="Select Expense Head." InitialValue="0" ValidationGroup="btnAddItemDetail" Display="Dynamic" CssClass="gst-ac-error"></asp:RequiredFieldValidator>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtDiscount" MaxLength="9" runat="server" CssClass="Money w56" Text="0" OnTextChanged="txtDiscount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <tr id="collapse_me_tr">
                                                ...
                                                <td style="width: 80px; position: relative; text-align: center; border-bottom-color: transparent; border-right-color: transparent">
                                                    ...
                                                    <div style="position: absolute; top: -54px; left: 50%; transform: translateX(-50%);">
                                                        ...
                                                        <asp:Button ID="btnAddItemDetail" runat="server" CssClass="btn btn-xs btn-primary" Text="Add" OnClick="btnAddItemDetail_Click" ValidationGroup="btnAddItemDetail" />
                                                    </div>
                                                </td>
                                        ...
                                        <asp:GridView ID="grdItemDetails" HeaderStyle-CssClass="hidden" CssClass="table table-voucher table-bordered table-form gstr_sales_item first_tr_hide" OnRowCommand="grdItemDetails_RowCommand" OnRowDataBound="grdItemDetails_RowDataBound" AutoGenerateColumns="false" runat="server" ShowHeader="True">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <tr>
                                                            <th rowspan="2" class="inf_head w12">Expense Head</th>
                                                            <th rowspan="2" class="inf_head w13">Item Name</th>
                                                            <th rowspan="2" class="inf_head w15">Goods /<br>
                                                                Service Code</th>
                                                            <th colspan="2" class="inf_head">Primary</th>
                                                            <th colspan="2" class="inf_head">Secondary</th>
                                                            <th rowspan="2" class="inf_head w4">Free</th>
                                                            <th rowspan="2" class="inf_head w5">Rate</th>
                                                            <th rowspan="2" class="inf_head w5">Net Amount</th>

                                                            <th colspan="3" class="inf_head">Discount</th>

                                                            <th rowspan="2" class="inf_head w2">Edit</th>
                                                            <th rowspan="2" class="inf_head w5">Taxable</th>
                                                            <th rowspan="2" class="inf_head w2">ITC</th>
                                                            <th rowspan="2" class="inf_head w5">Tax Rate</th>
                                                            <th rowspan="2" class="inf_head w5">CGST</th>
                                                            <th rowspan="2" class="inf_head w5">SGST</th>
                                                            <th rowspan="2" class="inf_head w5">IGST</th>
                                                            <th rowspan="2" class="inf_head w5">CESS</th>
                                                            <th rowspan="2" class="inf_head w5" style="text-align: center"></th>
                                                        </tr>
                                        ...
                                        <table class="table table-voucher gstr_sales_other table-bordered tbl_Free" id="Table4" runat="server">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="w9 c">
                                                        <asp:Button ID="btnFreeAdd" CssClass="btn btn-xs btn-primary btncss" OnClick="btnFreeAdd_Click" Text="Add" runat="server" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <asp:Panel ID="pnlPartyAdvance" runat="server" Visible="false" CssClass="grid_collapse col-xs-10">
                                        <asp:GridView ID="GvPartyAdvance" RowStyle-BackColor="" HeaderStyle-CssClass="inf_head" CssClass=" table-voucher gstr_sales_other table-bordered tbl_Free w91" OnRowDataBound="GvPartyAdvance_RowDataBound" ShowHeader="true" AutoGenerateColumns="false" runat="server" Style="width: 600px">
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass="w15 c" HeaderText="Transaction No.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblVoucharNo" Text='<%#Eval("VoucharNo") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField ItemStyle-CssClass="w17 c" DataField="VoucharDate" HeaderText="Transaction Date" DataFormatString="{0:dd/MM/yyyy}" />
