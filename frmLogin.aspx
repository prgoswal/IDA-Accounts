                            ...
                            <div class="row login">
                                <div class="form-signin form-horizontal  animated fadeIn" id="loginform">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:Panel ID="pnlFinancialYear" runat="server">
                                            <div class="form-group Year_parent ac_hidden animated fadeIn">
                                                <asp:DropDownList ID="ddlFinancialYear" CssClass="form-control select-year" runat="server"></asp:DropDownList>

                                            </div>
                                            <div class="form-group btn_final_login_parent_Year ac_hidden animated fadeIn">
                                                <asp:Button ID="btnYearSubmit" CssClass="btn btn-block btn-primary btn_final_login" Text="Continue" OnClick="btnYearSubmit_Click" runat="server" />
                                                <a href="#" id="btnBack3" class="btn_back_login hidden"><i class="fa r fa-chevron-left"></i>Back</a>
                                            </div>
            ...
            <script>
                ...
                $('input[type="password"]').keypress(function (e) {
                    ...
                    if (((kc >= 65 && kc <= 90) && !sk) || ((kc >= 97 && kc <= 122) && sk))
                        PopOverCapsLock(id, 'top', 'Caps Lock Is On');
                        //alert('Caps is Lock On');
                    else
                        $(id).popover('destroy');
                })

                function PopOverCapsLock(id, plac, msg) {
                    try {
                        $(id).popover({
                            //title: 'Error!',
                            trigger: 'manual',
