<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="frmBudgetGroup.aspx.cs" Inherits="BudgetMasters_frmBudgetGroup" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <%--    <script type="text/javascript" language="javascript">
            ...
            <div class="content-wrapper">
                <h3 class="text-center head">Group Entry/Updation
                </h3>
                ...
                <div class="container_fluid">
                    <div class="row">
                                ...
                                <div class="panel-body" style="min-height: 288px">
                                    <div class="form-horizontal">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <asp:TextBox ID="txtSectionName" onfocusin="Filter();" onkeyup="Filter()" placeholder="Group Name" CssClass="FilterAccountHead form-control" MaxLength="50" runat="server" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-sm-4  control-label">Group Name (Hindi)</label>
                                                    <div class="col-sm-8">

                                                        <cc1:TransliterateTextbox MaxLength="99" ID="txtSectionNameHindi" CssClass="form-control" Text="" placeholder="Group Name (Hindi)"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div style="width: 100%;height:348px" id="divListSection" onclick="ClickOnSectionDiv();" >


                                    <asp:ListBox ID="lstSeaction" runat="server" Style="height:348px;color: #000; width: 100%; position: absolute; height: 100%; background: #9ccef9; top: 0px;"></asp:ListBox>
                                    ...
                                    <div class="panel-body p0">
                                        ...
                                        <div style="padding-right: 17px;">
                                            <table class="table-bordered">
                                                <tr>
                                                    <th class="inf_head" style="width: 40%;">Group Name </th>


                                                    <th class="inf_head" style="width: 40%;">Group Name (Hindi)</th>
