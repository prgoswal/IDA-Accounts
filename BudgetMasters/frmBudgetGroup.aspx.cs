...
public partial class BudgetMasters_frmBudgetGroup : System.Web.UI.Page
{
            ...
            if (dtGRD.Rows.Count > 0)
            {
                ...
                if (dv31.Count > 0)
                {
                    for (int i = 0; i < dv31.ToTable().Rows.Count; i++)
                    {
                        ...
                        {
                            ShowMessage("Group Name is already exits.", false);
                            txtSectionName.Focus();
                            return false;
                        }
                    }
            ...
            if (dtGRD2.Rows.Count > 0)
            {
                ...
                if (dv.Count > 0)
                {
                    for (int i = 0; i < dv.ToTable().Rows.Count; i++)
                    {
                        ...
                        {
                            ShowMessage("Group Name(Hindi) is already exits.", false);
                            txtSectionNameHindi.Focus();
                            return false;
                        }
                    }
