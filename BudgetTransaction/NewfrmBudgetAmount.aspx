<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.master" AutoEventWireup="true" CodeFile="NewfrmBudgetAmount.aspx.cs" Inherits="BudgetTransaction_frmBudgetAmount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script> //For ListBox FIlter
        ...
        function sum() {
            ...
            if (!isNaN(result)) {
                document.getElementById('ContentPlaceHolder1_txtNewSanc2BudgetAmtDr').value = result;
            }
        }
        ...
        function sumCr() {
            ...
            var result = (parseFloat(txtFirstNumberValue) + parseFloat(txtSecondNumberValue)).toFixed(2);
            if (!isNaN(result)) {
                document.getElementById('ContentPlaceHolder1_txtNewSanc2BudgetAmtCr').value = result;
            }
        }
                                    ...
                                    <div class="">
                                        <table class="table-sm table-bordered table-pd-47" style="border: 0">
                                            ...
                                            <tr id="trRevBudgetAmt1718" runat="server" class="input-sm-tr" style="background: #ffdd9e; border-bottom: 1px solid #fff">
                                                ...
                                                <td>
                                                    <%--<asp:TextBox runat="server" Enabled="true" ID="txtSanc2BudgetAmtDr" MaxLength="8" CssClass="inpt Money form-control form-control-sm" />--%>

                                                    <asp:TextBox runat="server" Enabled="true" ID="txtNewSanc2BudgetAmtDr" MaxLength="8" CssClass="inpt Money form-control form-control-sm" />
                                                </td>
                                                <td>

                                                    <asp:TextBox runat="server" Enabled="true" ID="txtNewSanc2BudgetAmtCr" MaxLength="8" CssClass="inpt Money form-control form-control-sm" />
                                                    <%--<asp:TextBox runat="server" Enabled="true" ID="txtSanc2BudgetAmtCr" MaxLength="8" CssClass="inpt Money form-control form-control-sm" />--%>
                                                </td>
                                                <td>
