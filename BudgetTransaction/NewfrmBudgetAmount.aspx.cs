...
public partial class BudgetTransaction_frmBudgetAmount : System.Web.UI.Page
{
    ...
    private void CheckBudgetAmountIsExist()
    {
        try
        {
            ...
            if (dtSubSection.Rows.Count > 0)
            {
                ...
                txtNewSanc2BudgetAmtDr.Text = lblSanc2BudgetAmtDr.Text = (dtSubSection.Rows[0]["Sanc2BudgetAmtDr"].ToString() == "-1") ? "" : dtSubSection.Rows[0]["Sanc2BudgetAmtDr"].ToString();

                txtNewSanc2BudgetAmtCr.Text = lblSanc2BudgetAmtCr.Text = (dtSubSection.Rows[0]["Sanc2BudgetAmtCr"].ToString() == "-1") ? "" : dtSubSection.Rows[0]["Sanc2BudgetAmtCr"].ToString();
                ...
                //txtNewSanc2BudgetAmtDr.Text = lblSanc2BudgetAmtDr.Text = dtSubSection.Rows[0]["Sanc2BudgetAmtDr"].ToString();
    ...
    private void ClearFields()
    {
        txtActualUptoBudgetAmtDr.Text = lblActualUptoBudgetAmtDr.Text =
         ...
         txtPropBudgetCapitalAmtCr.Text = lblPropBudgetAmtCr.Text =
                    txtNewSanc2BudgetAmtDr.Text = lblSanc2BudgetAmtDr.Text =
                    txtNewSanc2BudgetAmtCr.Text = lblSanc2BudgetAmtCr.Text =
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           // CalCulateRevisedBudgetAmt();
            ...
            //if (txtNewSanc2BudgetAmtDr.Text == "" && txtNewSanc2BudgetAmtDr.Enabled == true)
            //    objNewBudgetAmountModel.Sanc2BudgetAmtDr = -1;
            //else
            //    objNewBudgetAmountModel.Sanc2BudgetAmtDr = CommonCls.ConvertDecimalZero(txtNewSanc2BudgetAmtDr.Text);


            //commented by Ashsish sir 13-03-2018
            ...
            objNewBudgetAmountModel.Sanc2BudgetAmtCr = (CommonCls.ConvertDecimalZero(txtNewSanc2BudgetAmtCr.Text));
    ...
    private void ClearAll()
    {
        ...
        txtProp2BudgetAmtCr.Text = txtNewSanc2BudgetAmtDr.Text = txtNewSanc2BudgetAmtCr.Text = "";
        ...
        txtPropLastQtrBudgetAmtCr.Enabled =
         ...
         txtPropBudgetCapitalAmtCr.Enabled =
            //  txtNewSanc2BudgetAmtDr.Enabled =
    ...
    protected void txtSectionName_TextChanged(object sender, EventArgs e)
    {
        ...
        //     DataTable dtFilter = VSMainSection;
        //if (dtFilter.Rows.Count > 0)
        //{
        //    DataView dvFilter = new DataView(dtFilter);
        //    dvFilter.RowFilter = "DeptParentID =" + SectionID + "";
        //    ddlSubSection.DataSource = dvFilter.ToTable();
        //    ddlSubSection.DataTextField = "DeptName";
        //    ddlSubSection.DataValueField = "DeptID";
        //    ddlSubSection.DataBind();
        //    if (dvFilter.ToTable().Rows.Count == 1)
        //    {
        //        ddlSubSection.SelectedValue = dvFilter.ToTable().Rows[0]["DeptID"].ToString();
        //        ddlSubSection_SelectedIndexChanged(sender, e);
        //    }
        //    else
        //    {
    ...
    private void CalCulateRevisedBudgetAmt()
    {
        ...
        else
        {
            ...
            txtNewSanc2BudgetAmtDr.Text = (Sanc2BudgetAmtDr).ToString();
        }
        ...
        else
        {
            ...
            txtNewSanc2BudgetAmtCr.Text = (Sanc2BudgetAmtCr).ToString();
        }
    }
